...
public class PersonMenu {
	...
	public void mainMenu() {
		while(true) {
			...
			System.out.println("*** 학생은 최대 "+ pc.s.length +"명까지 저장할 수 있습니다. ***");
			System.out.println("*** 현재 저장된 학생은 "+ countArr[0] +"명입니다. ***");
			System.out.println("*** 사원은 최대 "+ pc.e.length +"명까지 저장할 수 있습니다. ***");
