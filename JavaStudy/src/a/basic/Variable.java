...
public class Variable {
	 ...
	 */
		...
		System.out.print("equals) str2 == str3 : ");
		System.out.println(str2.equals(str3));	// 문자열.equals(비교하고 싶은 문자열)
		
		/*
		 * 이스케이프 시퀸스
		 * 문자열내에서 탭, 백슬래시, 작은 따옴표 등을 코드로 사용하기위한 방식
		 * 
		 * 탭문자 \t
		 * 백슬래시 \\
		 * 작은 따옴표 \'
		...
		final int MY_AGE;
		MY_AGE=90;
//      MY_AGE=111; 값을 초기화 하면 더이상 변경할 수 없다.
