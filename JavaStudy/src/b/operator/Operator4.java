...
public class Operator4 {
	 ...
	 * 동등비교연산 : ==, !=
	 * 
	 * 원시 타입 일반 변수 -> 동등비교를 ==, !=로 진행하면 된다.
	 * 
	 * String(문자열)은 단순하게 ==로 동등비교할 수 없다.
	 * 이유 : 참조변수(객체를 담는 변수)이기 때문에 String 비교시에는 문자열.equals(문자열);
	 */
	public static void main(String[] args) {
		...
		// 첫 번째 정수 :
		// 두 번째 정수 :
		// 첫 번째가 두번째보다 큽니다. : (true / false)
		// 첫 번째 정수는 짝수 입니다. (true / false)
